...
interface SidebarMenuCollapseProps {
    icon?: RouteInterface["icon"];
    title: string;
    items: RouteInterface[];
}

export default function SidebarMenuCollapse(props: SidebarMenuCollapseProps) {
    ...
    return (
        <div className="flex gap-4 h-full items-center cursor-pointer">
            <Accordion className="px-0">
                ...
                >
                    <div className="pl-12">
                        {items.map((item: RouteInterface, index: number) => (
                            <Link
                                key={index}
                                href={item.path}
